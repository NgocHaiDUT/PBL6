import { Controller, Post, Body, Get, Query, Param, Delete, Patch, ParseIntPipe } from '@nestjs/common';
...
export class ShopAddressController {
    ...
    async updateShopAddress(
        ...
        return this.shopAddressService.updateShopAddress(addressId, updateShopAddressDto);
    }
